...
- **[Rendering](reference/rendering/graphics-pipeline.md)** — VGA Mode 12h pipeline, sprite blitting, palette management
...
- **[AI](reference/ai/ai-behavior.md)** — Monster AI pathfinding, combat logic, cheat-code player names
