...
void test_defaults(void)
{
    ...
    TEST_ASSERT_EQUAL_HEX8(0x2D, g_config.config_byte);
    ...
    TEST_ASSERT_EQUAL(100, g_config.starting_lives);
...
void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT_EQUAL(50, g_config.starting_lives);
}
...
void test_binary_layout(void)
{
    ...
    TEST_ASSERT_EQUAL_HEX8(0xAB, buf[1]);    /* config_byte */
    ...
    TEST_ASSERT_EQUAL_HEX8(0xEE, buf[16]);   /* starting_lives */
}
